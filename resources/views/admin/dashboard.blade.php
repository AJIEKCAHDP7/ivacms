    ...
    <header class="header">
        <div class="logo-container">
            <a href="../2.0.0" class="logo">
                <img src="img/logo.png" width="75" height="35" alt="IVA CMS" />
            </a>
            ...
            <div id="userbox" class="userbox">
                ...
                <div class="dropdown-menu">
                    <ul class="list-unstyled mb-2">
                        ...
                        <li>
                            <a role="menuitem" tabindex="-1" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-power-off"></i> {{ __('Logout') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
